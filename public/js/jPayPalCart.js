...
(function ($) {
    ...
    function PayPalCartdisplay(theDiv) {
        ...
        for (var i = 0; i < theDiv.settings.cartItems.length; i++) {
            ...
            theform += '<input type="hidden" readonly name="quantity_' + (i + 1).toString() + '" value="' + theDiv.settings.cartItems[i]['quantity'] + '" />\r\n';
        ...
        theform += '<tr class="PayPalCartTotals"><td colspan="3" align="left">Tax</td><td align="right">' + theDiv.settings.currencysign + parseFloat(overalltax).toFixed(2) + '</td></tr>\r\n';
